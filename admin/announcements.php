...
// Check Logic: Announcement Management is for Admin and Teachers only
if ($role !== 'admin' && $role !== 'sub_admin' && $role !== 'teacher') {
    redirect('notifications.php'); // Students/Parents redirect to view
}
